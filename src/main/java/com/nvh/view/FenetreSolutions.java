...
public class FenetreSolutions extends JInternalFrame implements Observer {
    ...
    public FenetreSolutions() {
        ...
        btnVoir.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 16));
        ...
        table.getTableHeader().setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 14));
        table.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 14));
    ...
    public void update(Observable o, Object arg) {
        ...
        if (arg instanceof List<?>) {
            ...
            for (Object s : (List<?>) arg) {
                ...
                if (((Solution) s).getRetour()[1] == "[]" && Main.partie.getTirage().length() > 6)
