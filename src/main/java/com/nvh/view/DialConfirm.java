...
public class DialConfirm extends JDialog 
{
	...
	public DialConfirm (Scrabble partie)
	{
		setTitle("TIRAGE");
		setModal(true);
		...
		zoneTexte.setFont(new Font(FenetrePrincipale.mainFont, Font.BOLD, 48));
		...
		public DialConfirm(Scrabble partie, int j, Solution s) {
		...
		zoneTexte.setForeground(Color.BLUE);
		zoneTexte.setDisabledTextColor(UIManager.getColor("ToggleButton.light"));
		zoneTexte.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 16));
		zoneTexte.setHorizontalAlignment(SwingConstants.CENTER);
