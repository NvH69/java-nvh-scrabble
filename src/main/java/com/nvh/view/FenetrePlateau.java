...
public class FenetrePlateau extends JInternalFrame implements Observer {
    ...
    String chemin = Dictionnaire.chemin + "/letters/wood/";
    ...
    public FenetrePlateau() {
        ...
        ImagePanel plateau = new ImagePanel(new ImageIcon(Dictionnaire.chemin+"/boards/boardr0.jpg").getImage(), 0, 0);
    ...
    public static void displayGrille(Grille gd, Object o) {//dessine une grille enti�re
        for (int x = 0; x < 15; x++) {
            for (int y = 0; y < 15; y++) {
