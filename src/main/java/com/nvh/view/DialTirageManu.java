...
public class DialTirageManu extends JDialog {
    ...
    public DialTirageManu(Scrabble partie) {
        setModal(true);
        ...
        tf.setText("");
        tf.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 28));
        ...
        lblEntrerNouvellesLettres.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 12));
        ...
        toggleType.setFont(new Font(FenetrePrincipale.mainFont, Font.PLAIN, 24));
